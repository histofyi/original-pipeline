...
def process_pocket_images(assembly_name, image_input_folder, image_output_folder):
    ...
    for size in ['large','medium']:
        try:
            pockets_image = f'{image_input_folder}/{assembly_name}_pockets_{size}.png'
            pocket_labels = f'assets/labels/pocket_labels_{size}.png'
...
def main():
    ...
    image_input_folder = f'{config["IMAGES_PATH"]}/cleft/pockets/unlabelled'
    image_output_folder = f'{config["IMAGES_PATH"]}/cleft/pockets/labelled'
